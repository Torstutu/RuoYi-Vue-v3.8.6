<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="力扣题目链接" prop="questionLink">
        <el-input
          v-model="queryParams.questionLink"
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['leetcode:questions:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['leetcode:questions:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['leetcode:questions:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['leetcode:questions:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="questionsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="力扣题目链接" align="center" prop="questionLink" />
      <el-table-column label="题目描述" align="center" prop="questionRemark" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="力扣题目链接" prop="questionLink">
          <el-input v-model="form.questionLink" placeholder="请输入力扣题目链接" />
        </el-form-item>
        <el-form-item label="题目描述" prop="questionRemark">
          <el-input v-model="form.questionRemark" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listQuestions, getQuestions, delQuestions, addQuestions, updateQuestions } from "@/api/leetcode/questions";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除力扣题单编号为"' + questionIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('leetcode/questions/export', {
        ...this.queryParams
